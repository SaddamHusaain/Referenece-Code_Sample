...
export const EventActionTypes = {
  ...
  SET_PERFORMANCE_SONG_LINK: "SET_PERFORMANCE_SONG_LINK",
  SET_PERFORMANCE_VIDEO_LINK: "SET_PERFORMANCE_VIDEO_LINK",
...
export interface SetPerformanceSongLinkAction {
  type: typeof EventActionTypes.SET_PERFORMANCE_SONG_LINK;
  payload: {
    eventId: string;
    performanceId: string;
    songLink: string;
...
export function setPerformanceSongLink(
  eventId: string,
  performanceId: string,
  songLink: string
): SetPerformanceSongLinkAction {
  return {
    type: EventActionTypes.SET_PERFORMANCE_SONG_LINK,
    payload: {
      eventId,
      performanceId,
      songLink,
...
export interface SetPerformanceVideoLinkAction {
  type: typeof EventActionTypes.SET_PERFORMANCE_VIDEO_LINK;
  payload: {
    eventId: string;
    performanceId: string;
    videoLink: string;
...
export function setPerformanceVideoLink(
  eventId: string,
  performanceId: string,
  videoLink: string
): SetPerformanceVideoLinkAction {
  return {
    type: EventActionTypes.SET_PERFORMANCE_VIDEO_LINK,
    payload: {
      eventId,
      performanceId,
      videoLink,
