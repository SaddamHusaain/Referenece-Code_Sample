...
import Label from "@app/ui/build/components/Label";
import Icon, { Icons } from "@app/ui/build/components/Icon";
...
const AddPayment: React.FC<AddPaymentProps> = ({ event }) => {
    /** State **/
    const [focused, setFocus] = React.useState<ElementsEnum | null>(null);
    const { app: { mode, errors } } = useSelector((state: PurchasePortalState) => state);
